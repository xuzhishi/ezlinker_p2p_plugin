...
load_ ( Hook , Fun , Params ) -> case Hook of 'client.connected' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 4 , [ Params ] ) ; 'client.disconnected' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 4 , [ Params ] ) ; 'client.subscribe' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 4 , [ Params ] ) ; 'client.unsubscribe' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 4 , [ Params ] ) ; 'session.subscribed' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 4 , [ Params ] ) ; 'session.unsubscribed' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 4 , [ Params ] ) ; 'message.publish' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 2 , [ Params ] ) ; 'message.acked' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 3 , [ Params ] ) ; 'message.delivered' -> emqx : hook ( Hook , fun ( ? MODULE ) : Fun / 3 , [ Params ] ) end .


unload_ ( Hook , Fun ) -> case Hook of 'client.connected' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 4 ) ; 'client.disconnected' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 4 ) ; 'client.subscribe' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 4 ) ; 'client.unsubscribe' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 4 ) ; 'session.subscribed' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 4 ) ; 'session.unsubscribed' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 4 ) ; 'message.publish' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 2 ) ; 'message.acked' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 3 ) ; 'message.delivered' -> emqx : unhook ( Hook , fun ( ? MODULE ) : Fun / 3 ) end .
